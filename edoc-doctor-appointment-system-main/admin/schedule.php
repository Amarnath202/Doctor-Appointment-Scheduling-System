...
<div class="page-container">
    ...
    <div class="top-navbar">
        <div class="user-profile">
            <div class="user-info">
                ...
                <div>
                    ...
                    <p class="user-email">admin@edoc.com</p>
                </div>
            </div>
            <div class="nav-links">
            <a href="index.php" class="nav-item">Dashboard</a>
            <a href="doctors.php" class="nav-item">Doctors</a>
            <a href="patient.php" class="nav-item">Patients</a>
            <a href="schedule.php" class="nav-item">Schedule</a>
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding: 2px;0;margin-top:  95px; ">
                <tr >
                    <td width="13%" >
