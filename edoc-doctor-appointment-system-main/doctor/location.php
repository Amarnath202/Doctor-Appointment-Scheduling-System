...
<head>
    ...
    <style>
        body {
            ...
            text-align: center;
            background: url("../images/img14.jpg") no-repeat center center fixed;
        ...
        .doctor-card {
            background: rgba(233, 236, 237, 0.95);
            padding: 20px;
            margin-bottom: 15px;
            border-radius: 12px;
        ...
        <?php if (count($doctors) > 0): ?>
            <?php foreach ($doctors as $doctor): ?>
                <div class="doctor-card" data-specialization="<?php echo htmlspecialchars($doctor['specialization']); ?>">
                    ...
                    <a href="patient.php?id=<?php echo $doctor['docid'];  ?>" class="non-style-link">
                        <button class="btn-primary-soft btn button-icon btn-view" style="padding: 12px 40px; margin-top: 10px;">View</button>
                    </a>
                </div>
            <?php endforeach; ?>
        <?php else: ?>
